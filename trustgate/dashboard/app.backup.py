...
<head>
    ...
    <style>
        ...
        .pipe { position: absolute; background: #00ff8844; height: 4px; transform-origin: left center; }
        .pipe.attacked { background: #ff000088; }
...
<body>
    ...
    {% if report %}
        ...
        <div class="plant-map">
            ...
            <!-- Components positioned by coordinate (x*4.5%, y scaled to 280px) -->
            {% for reg, asset in assets.items() %}
                ...
                <div class="component {% if is_attacked %}attacked{% endif %}"
                    ...
                    <div class="icon">
                        {% if asset.type == "pump" or asset.type == "chemical_pump" or asset.type == "high_pressure_pump" %}⚙️
                        {% elif asset.type == "sensor" %}📊
                        {% elif asset.type == "chemical_valve" %}☣️
                        {% elif asset.type == "safety_valve" or asset.type == "emergency_valve" %}🔒
                        {% else %}🔧
                        {% endif %}
                    </div>
