...
EXCLUDE_FILES = [
    ...
    '/usr/sbin/wait-for-root',    # legitimate boot binary
    '/usr/sbin/ldconfig',          # dynamic linker cache
    '/usr/sbin/ldconfig.real',     # same
    '/usr/bin/sync',               # core utility
    '/usr/bin/rmdir',              # core utility
    '/usr/sbin/fstrim'             # filesystem utility
]
